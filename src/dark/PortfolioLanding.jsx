...
const PortfolioLanding = () => {
    let title = 'About Me',
        description = 'I am a UI/UX Designer with professional front-end engineering experience who designs software for mission-driven companies to make our world a little bit better. My designs are maintainable, evidence-based, and accessible. My innovative path into the tech industry provides me with interdisciplinary insights when designing for all types of people.';
                                ...
                                <div className="row">
                                    <div className="col-lg-12">
                                        <div className={`inner ${value.textPosition}`}>
                                            ...
                                            <h1 className="title">Hi, I’m Sam Sterns <br/>
                                            <TextLoop>
                            ...
                            <div className="row row--35 align-items-center">
                                <div className="col-lg-5">
                                    <div className="thumbnail">
                                        <img className="w-100" src="/assets/images/about/selfPortrait.png" alt="About Images"/>
                                    </div>
                                </div>
