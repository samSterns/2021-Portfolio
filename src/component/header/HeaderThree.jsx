                ...
                <div className="header-wrapper">
                    ...
                    <div className="header-right">
                        <div className="social-share-inner">
                            <ul className="social-share d-flex justify-content-start liststyle">
                                {SocialShare.map((val , i) => (
                                    <li key={i}><a target="_blank" rel="noopener noreferrer" alt={val.Social} href={`${val.link}`}>{val.Social}</a></li>
                                ))}
                            </ul>
                        </div>
